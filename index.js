...
if (!fs.existsSync(__dirname + '/Sonic_session/creds.json')) {
  ...
  filer.download((err, data) => {
      if (err) throw err;
      fs.writeFile(__dirname + '/Sonic_session/creds.json', data, () => {
          console.log("SESSION INSTALLED COMPLETED ✅");
      });
  });
}
...
async function connectToWA() {
  console.log("CONNECTING Sonic-MD BOT...");
  const { state, saveCreds } = await useMultiFileAuthState(__dirname + '/Sonic_session/');
  ...
  const sendBotImage = (up) => {
      ...
      if (fs.existsSync(localImgPath)) {
          ...
          const fallbackUrl = 'https://raw.githubusercontent.com/Lil-Leoz/bot-help/refs/heads/main/IMG-20250407-WA0004.jpg';
...
//============================================================================
app.get("/", (req, res) => {
  res.sendFile(path.join(__dirname, 'Sonic_website/index.html'));
});
