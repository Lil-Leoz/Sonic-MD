...
module.exports = {
    ...
    ALIVE_IMG: process.env.ALIVE_IMG || "https://raw.githubusercontent.com/Lil-Leoz/bot-help/refs/heads/main/IMG-20250407-WA0004.jpg",

    // Alive message to be shown when the bot is online (can be customized)
    ALIVE_MSG: process.env.ALIVE_MSG || "Hy Bro I'm Alive😊",
    ...
    BOT_NAME: process.env.BOT_NAME || "➺Sonic-MD࿐",
